...
@section('auth-content')
    <div class="p-4 md:p-16 h-full w-full flex flex-col items-center justify-center">
        ...
        <form action="#" class="w-full flex flex-col gap-2 px-2 md:px-4">
            ...
            <button class="w-full bg-yellow-400 text-white p-2 rounded-md mt-4 hover:bg-yellow-500 transition duration-100" type="submit">Sign In</button>
        </form>
        <div class="text-sm mt-4">
            Belum punya akun?
            <a href="{{ route('register') }}" class="text-yellow-400 hover:text-yellow-500 transition duration-100"> Daftar disini</a>
        </div>
    </div>
@endsection
